...
def fit_model_dense(n_train, n_val, n_test, iX, iY, patience, split):
    ...
    for fold in range(split):
        ...
        early_stopping = EarlyStopping(patience=7000, min_delta=0.005)
...
for ii in range(len(train_set)):
    ...
    chdir(current_dir)
    os.chdir(current_dir + '/withdft/split/egap/qm9/slatm/PureRandom/')
    try:
        os.mkdir(str(train_set[ii]))
    except:
        pass
    os.chdir(current_dir + '/withdft/split/egap/qm9/slatm/PureRandom/' + str(train_set[ii]))
