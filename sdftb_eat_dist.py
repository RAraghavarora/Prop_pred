...
# prepare dataset
train_set = ['16000', '500', '4000', '25000']
op = 'EAT'
splits = {
    500: 22,
    1000: 12,
...
for ii in range(len(train_set)):
    ...
    chdir(current_dir)
    os.chdir(current_dir + '/withdft/split/eat/dist/slatm/PureRandom/')
    try:
        os.mkdir(str(train_set[ii]))
    except:
        pass
    os.chdir(current_dir + '/withdft/split/eat/dist/slatm/PureRandom/' + str(train_set[ii]))
